class ArticlesController < ApplicationController
  ...
  def index
    ...
    def article_params
      params.require(:article).permit(:name, :price_cost, :percentaje, :price_total, :quantity, :barcode, :supplier_id, :category_id, :due_date, :image, :allow_negative, :minimum_stock, :quantity_package, :iva, :allow_change_price, deadlines_attributes:[:id, :article_id, :due_date])
    end
  end
